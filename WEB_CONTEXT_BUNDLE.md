...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-890-erd-s-problem-890-23a55db2-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-890"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-890-erd-s-problem-890-23a55db2-v1",
      "problem_contract_sha256": "0e9c01e93705d9ec62a8640b5916cb95de78ac332c6becc16d8fc8281d36393f",
      "problem_id": "problem:um-ep-890-erd-s-problem-890-23a55db2",
      "route_id": "route:um-ep-890-erd-s-problem-890-23a55db2-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-890-erd-s-problem-890-23a55db2-source-fidelity-01",
      "graph_id": "graph:um-ep-890-erd-s-problem-890-23a55db2-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-890-erd-s-problem-890-23a55db2-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-890-erd-s-problem-890-23a55db2-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "If $\\omega(n)$ counts the number of distinct prime factors of $n$, then is it true that, for every $k\\geq 1$, $ \\liminf_{n\\to \\infty}\\sum_{0\\leq i<k}\\omega(n+i)\\leq k+\\pi(k)? $ Is it true that $ \\limsup_{n\\to \\infty}\\left(\\sum_{0\\leq i<k}\\omega(n+i)\\right) \\frac{\\log\\log n}{\\log n}=1? $"
          },
          "statement_sha256": "a982061860ed60f571addb7024b870d570d7b41d3dacaec920ef5118bdd75f84"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-890-erd-s-problem-890-23a55db2-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-890-erd-s-problem-890-23a55db2-root",
      "route_id": "route:um-ep-890-erd-s-problem-890-23a55db2-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-890-caf0c80067de",
        "url": "https://www.unsolvedmath.com/problems/EP-890"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
